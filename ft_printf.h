...
void	conv_num(const char *format, va_list args, char *flags, size_t *b_writ);
void	conv_hex(const char *format, va_list args, char *flags, size_t *b_writ);
void	conv_txt(const char *format, va_list args, size_t *b_writ);
